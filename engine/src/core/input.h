...
UAPI BOOLEAN InputIsKeyDown(Keys key);
UAPI BOOLEAN InputIsKeyUp(Keys key);
UAPI BOOLEAN InputWasKeyDown(Keys key);
UAPI BOOLEAN InputWasKeyUp(Keys key);

void InputProcessKey(Keys key, BOOLEAN pressed);

UAPI BOOLEAN InputIsMouseButtonDown(MouseButton button);
UAPI BOOLEAN InputIsMouseButtonUp(MouseButton button);
UAPI BOOLEAN InputWasMouseButtonDown(MouseButton button);
UAPI BOOLEAN InputWasMouseButtonUp(MouseButton button);
UAPI void InputGetMousePosition(i32 *x, i32 *y);
UAPI void InputGetMousePreviousPosition(i32 *x, i32 *y);

void InputProcessMouseButton(MouseButton button, BOOLEAN pressed);
